...
<ref:refname>db2html-label.label</ref:refname>
...
<ref:para>
  ...
  <ref:function>db2html-label.label.mode</ref:function> to the node.  To
  change the behavior of a particular type of element, then, you should
  always override the mode template for that type of element.
</ref:para>
<ref:para>
  Overriding the <ref:function>db2html-label.label</ref:function> template
  should only be done if you wish to change the labelling mechanism completely,
...
<ref:para>
  ...
  generally call <ref:function>db2html-label.name</ref:function> and
  <ref:function>db2html-label.number</ref:function> to generate these portions.
</ref:para>

<xsl:template name="db2html-label.label">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <xsl:apply-templates mode="db2html-label.label.mode" select="$node"/>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>

<xsl:template mode="db2html-label.label.mode" match="
...
<xsl:template mode="db2html-label.label.mode" match="synopfragment">
  <xsl:text>(</xsl:text>
  <xsl:call-template name="db2html-label.number"/>
  <xsl:text>)</xsl:text>
</xsl:template>

<xsl:template mode="db2html-label.label.mode" match="title | subtitle">
...
<ref:para>
  ...
  <ref:function>db2html-label.name.mode</ref:function> to the node.  To change
...
<ref:para>
  ...
  mode <ref:function>db2html-label.number.mode</ref:function> to the node.
